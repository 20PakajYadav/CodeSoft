...
if __name__ == "__main__":
    ...
    task_label = Label(function_frame, text="Enter Task:", font=("Arial", 28, "bold"), bg="#E0E0E0", fg="#004080")
    ...
    add_button = Button(function_frame, text="Submit Task", width=11, height=2, bg="#f018af", font=("Arial", 14, "bold"), command=add_task)
    delete_button = Button(function_frame, text="Delete Task", width=11, height=2, bg="#f018af", font=("Arial", 14, "bold"), command=delete_task)
    delete_all_button = Button(function_frame, text="DelAllTasks", width=11, height=2, bg="#f018af", font=("Arial", 14, "bold"), command=delete_all_tasks)
    exit_button = Button(function_frame, text="Exit", width=52, height=2, bg="#f018af", font=("Arial", 14, "bold"), command=close_app)
